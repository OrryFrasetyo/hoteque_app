...
class Schedule {
  ...
  final EmployeeInDepartment employee;
  final int id;
  final Shift shift;
  final String status;
  ...
  factory Schedule.fromJson(Map<String, dynamic> json) => Schedule(
    ...
    employee: EmployeeInDepartment.fromJson(json["employee"]),
    id: json["id"],
...
class EmployeeInDepartment {
  ...
  factory EmployeeInDepartment.fromJson(Map<String, dynamic> json) =>
      EmployeeInDepartment(
        id: json["id"],
        name: json["name"],
