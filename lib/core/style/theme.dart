...
class MaterialTheme {
  ...
  static ColorScheme lightScheme() {
    return const ColorScheme(
      ...
      primary: Color(0xFF90612D),
      surfaceTint: Color(0xFF90612D),
      onPrimary: Color(0xffffffff),
      primaryContainer: Color(0xFFFFD8A8),
      onPrimaryContainer: Color(0xFF4A2E0F),
      secondary: Color(0xFFB38B6D),
      onSecondary: Color(0xffffffff),
      secondaryContainer: Color(0xFFFFE3C3),
      onSecondaryContainer: Color(0xFF5E3D24),
      tertiary: Color(0xFF8D6E63),
      onTertiary: Color(0xffffffff),
      tertiaryContainer: Color(0xFFFFDBCF),
      onTertiaryContainer: Color(0xFF44291D),
      error: Color(0xffba1a1a),
      onError: Color(0xffffffff),
      errorContainer: Color(0xffffdad6),
      onErrorContainer: Color(0xff93000a),
      surface: Color(0xfffefaf6),
      onSurface: Color(0xff161412),
      onSurfaceVariant: Color(0xff4d4237),
      outline: Color(0xff8e7b6a),
      outlineVariant: Color(0xffd8c5b2),
      shadow: Color(0xff000000),
      scrim: Color(0xff000000),
      inverseSurface: Color(0xff3e3328),
      inversePrimary: Color(0xFFc49b6a),
      primaryFixed: Color(0xFFFFD8A8),
      onPrimaryFixed: Color(0xFF4A2E0F),
      primaryFixedDim: Color(0xFFC49B6A),
      onPrimaryFixedVariant: Color(0xFF654321),
      secondaryFixed: Color(0xFFFFE3C3),
      onSecondaryFixed: Color(0xFF3F2A18),
      secondaryFixedDim: Color(0xFFCCAA8E),
      onSecondaryFixedVariant: Color(0xFF5E3D24),
      tertiaryFixed: Color(0xFFFFDBCF),
      onTertiaryFixed: Color(0xFF3A251B),
      tertiaryFixedDim: Color(0xFFAF8B7E),
      onTertiaryFixedVariant: Color(0xFF44291D),
      surfaceDim: Color(0xffe8e0d9),
      surfaceBright: Color(0xfffefaf6),
      surfaceContainerLowest: Color(0xffffffff),
      surfaceContainerLow: Color(0xfffaf2ea),
      surfaceContainer: Color(0xfff4ece4),
      surfaceContainerHigh: Color(0xffeee6de),
      surfaceContainerHighest: Color(0xffe8e0d8),
    );
  }
